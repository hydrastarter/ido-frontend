...
export const Admin: React.FC = () => {
  ...
  //               }
  //             ],
  //             "name": "updateLaunchpadFactoryAddress",
  //             "outputs": [],
  //             "stateMutability": "nonpayable",
  //             "type": "function"
  //           }
  ...
  //         selectedSigner.signer
  //       );
  //       const tx = await proxyContract.addDeployerAddress(selectedSigner.evmAddress);
  //       console.log("tx===",tx);
  //     }
  //   } catch (error) {
  //     console.error(error);
