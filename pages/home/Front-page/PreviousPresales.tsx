    ...
    return (
        <>
            ...
            <div className='presales-section'>
                        ...
                        apiData2 ?
                            ...
                            <div className='slider-mn'>
                                <Slider {...sliderSettings} ref={customeSlider} className="Journeynumber">
                                    {
                                        apiData2?.slice(0, 6).map((res : any, i:number) => {
                                                        ...
                                                        <div className="journey-des-btm">
                                                            ...
                                                            <div className='goals-se'>
                                                                <div className='goals-box'>
                                                                    ...
                                                                    <h2>${res.minimumTokenSaleAmount * res.inputTokenRate}</h2>
                                                                </div>
                                                                <div className='goals-box'>
                ...
                <div className="main"><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span><span className="bubble"></span></div>
            </div>
                    ...
                    </div>
                    {
                        apiData2 ?
                            <div className='slider-mn'>
                                <Slider {...sliderSettings} ref={customeSlider} className="Journeynumber">
                                    {
                                        apiData2?.slice(6, 12).map((res:any, i:number) => {
                                            let date = new Date(res.vestingStart * 1000);
                                            const formattedDate = date.toLocaleDateString();
                                            const formattedTime = date.toLocaleTimeString();
